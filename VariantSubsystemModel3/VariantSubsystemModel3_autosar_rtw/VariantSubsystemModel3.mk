###########################################################################
## Makefile generated for Simulink model 'VariantSubsystemModel3'. 
## 
## Makefile     : VariantSubsystemModel3.mk
## Generated on : Fri Jun 15 16:33:20 2018
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/VariantSubsystemModel3.exe
...
PRODUCT_NAME              = VariantSubsystemModel3
MAKEFILE                  = VariantSubsystemModel3.mk
COMPUTER                  = PCWIN64
...
MODELREF_LINK_RSPFILE_NAME = VariantSubsystemModel3_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = VariantSubsystemModel3_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/VariantSubsystemModel3.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/VariantSubsystemModel3_autosar_rtw -I$(START_DIR)/Variants -I$(START_DIR)/VariantSubsystemModel3_autosar_rtw/stub -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=VariantSubsystemModel3 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/VariantSubsystemModel3_autosar_rtw/VariantSubsystemModel3.c
...
OBJS = VariantSubsystemModel3.obj
...
%.obj : $(START_DIR)/VariantSubsystemModel3_autosar_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")


%.obj : $(START_DIR)/VariantSubsystemModel3_autosar_rtw/stub/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
