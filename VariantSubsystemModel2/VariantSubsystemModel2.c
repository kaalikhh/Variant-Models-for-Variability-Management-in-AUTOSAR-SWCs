...
#include "VariantSubsystemModel2.h"
...
void Runnable_Step(void)
{
  ...
  /* DiscretePulseGenerator: '<Root>/In1' */
  rtb_In1 = ((rtDW.clockTickCounter < 5) && (rtDW.clockTickCounter >= 0));
  ...
  /* End of DiscretePulseGenerator: '<Root>/In1' */
   ...
   *  Gain: '<S2>/Gain'
   */
  rtDW.DiscreteTimeIntegrator1_DSTATE += 2.0 * (real_T)rtb_In1;
}
