###########################################################################
## Makefile generated for Simulink model 'VariantSubsystemModel1'. 
## 
## Makefile     : VariantSubsystemModel1.mk
## Generated on : Fri Jun 15 15:45:46 2018
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/VariantSubsystemModel1.exe
...
PRODUCT_NAME              = VariantSubsystemModel1
MAKEFILE                  = VariantSubsystemModel1.mk
COMPUTER                  = PCWIN64
...
MODELREF_LINK_RSPFILE_NAME = VariantSubsystemModel1_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = VariantSubsystemModel1_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/VariantSubsystemModel1.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/VariantSubsystemModel1_autosar_rtw -I$(START_DIR)/Variants/VariantSubsystemModel1 -I$(START_DIR)/VariantSubsystemModel1_autosar_rtw/stub -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=VariantSubsystemModel1 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/VariantSubsystemModel1_autosar_rtw/VariantSubsystemModel1.c
...
OBJS = VariantSubsystemModel1.obj
...
%.obj : $(START_DIR)/VariantSubsystemModel1_autosar_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")


%.obj : $(START_DIR)/VariantSubsystemModel1_autosar_rtw/stub/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
